...
const ones = new TotalOneNumber({ val: 1, description: "1 per point per 1" })
const twos = new TotalOneNumber({ val: 2, description: "2 per point per 2" })
const threes = new TotalOneNumber({ val: 3, description: "3 per point per 3" })
const fours = new TotalOneNumber({ val: 4, description: "4 per point per 4" })
const fives = new TotalOneNumber({ val: 5, description: "5 per point per 5" })
const sixes = new TotalOneNumber({ val: 6, description: "6 per point per 6" })
...
const fourOfKind = new SumDistro({
  count: 4,
  description: "Sum all fice if 4 are the same",
})
...
const smallStraight = new SmallStraight({
  score: 30,
  description: "30 point for a small straight",
})
